...
documents_pickle=open("documents.pickle","rb")
documents=pickle.load(documents_pickle)
documents_pickle.close()

word_features_pickle=open("wordfeatures.pickle","rb")
...
feature_sets_pickle=open("featuresets.pickle","rb")
...
NaiveBayesClassifier_pickle=open("NaiveBayesClassifier.pickle","rb")
...
MNBClassifier_pickle=open("MNBClassifier.pickle","rb")
...
BernoulliNB_pickle=open("BernoulliNBClassifier.pickle","rb")
...
LogisticRegression_pickle=open("LogisticRegression.pickle","rb")
...
LinearSVC_pickle=open("LinearSVC.pickle","rb")
...
NuSVC_pickle=open("NuSVC.pickle","rb")
